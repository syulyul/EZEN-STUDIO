...
public class NoticeBoardBean {
	...
	public int getNotice_re_level() {
		return notice_re_level;
	}
	public void setNotice_re_level(int notice_re_level) {
		this.notice_re_level = notice_re_level;
	}
