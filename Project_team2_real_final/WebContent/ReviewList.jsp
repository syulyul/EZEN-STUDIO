...
<div class="content" align="center">
        ...
        %>
        	<tr height="40">
				...
				<td width="500" align="left">
					<a href="ReviewInfo.jsp?num=<%=rbean.getNum() %>" style="text-decoration:none">
				...
				<td width="150" align="center"><%=rbean.getWriter() %></td>
				<td width="150" align="center"><%=rbean.getReg_date() %></td>
				<td width="100" align="center"><%=rbean.getReadcount() %></td>
			</tr>	
		<%
			}
		%>
	...
	<%
		if(listCount > 0){
			...
			if(startPage > 10){
	%>
			<a href="ReviewList.jsp?pageNum=<%=startPage-10 %>" style="text-decoration:none">[이전]</a>
	<%
			}
			// 페이징 처리
			for(int i=startPage;i<=endPage;i++){
	%>
			<a href="ReviewList.jsp?pageNum=<%=i %>" style="text-decoration:none">[<%=i %>]</a>
	<%
			}
			// 다음이라는 링크를  만들건지 파악
			if(endPage < pageCount){
	%>			
			<a href="ReviewList.jsp?pageNum=<%=startPage+10 %>" style="text-decoration:none">[다음]</a>
	<%
			}
		}
	%>
    ...
    <!--  검색 부분 -->
    <br>
        <form action="ReviewListProc.jsp">
