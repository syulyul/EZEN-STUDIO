...
<div class="content" align="center">
    ...
    <table width="1000">		
        ...
        %>
        	<tr height="40">
				...
				<td width="100" align="center"><%=bean.getNotice_reg_date() %></td>
				<td width="60" align="center"><%=bean.getNotice_readcount() %></td>
			</tr>	
		<%
			}
		%>
	...
	<%
		if(listCount > 0){
			...
			if(startPage > 10){
	%>
			<a href="NoticeBoardList.jsp?pageNum=<%=startPage-10 %>" style="text-decoration:none">[이전]</a>
	<%
			}
			// 페이징 처리
			for(int i=startPage;i<=endPage;i++){
	%>
			<a href="NoticeBoardList.jsp?pageNum=<%=i %>" style="text-decoration:none">[<%=i %>]</a>
	<%
			}
			// 다음이라는 링크를  만들건지 파악
			if(endPage < pageCount){
	%>
			<a href="NoticeBoardList.jsp?pageNum=<%=startPage+10 %>" style="text-decoration:none">[다음]</a>
	<%
			}
		}
	%>
    ...
    <!--  검색 부분 -->
    <br>
        <form action="NoticeBoardListProc.jsp">
