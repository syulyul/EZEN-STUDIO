...
<h2 align="center">게시글 삭제하기</h2><br>
	<form action="ReviewDeleteProc.jsp" method="post">
		<table width="600">
			<tr height="40">
				...
				<td width="120" style="text-decoration:none; padding-left: 10px; padding-right: 10px;"><%=rbean.getReg_date()%></td>
			</tr>
			<tr height="40">
				<td width="120" align="center" style="background-color:#F2F2F2; font-weight: 700;">제목</td>
				<td align="left" colspan="3" style="text-decoration:none; padding-left: 10px; padding-right: 10px;"><%=rbean.getSubject()%></td>
			</tr>
			<tr height="40">
