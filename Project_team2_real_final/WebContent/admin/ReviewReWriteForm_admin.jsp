...
<head>
<meta charset="UTF-8">
<title>ReviewReWriteForm_admin</title>
<style type="text/css">
...
<div class="content" align="center">
	...
	<form action="ReviewReWriteProc_admin.jsp" method="post">
	<%
			if (session.getAttribute("loginAdmin") != null) {
	%>
	
	<input type="hidden" name="id" size="40" style="background-color: #F2F2F2;" value="${loginAdmin.id }">
			
		<table width="600">
			<tr height="40">
				<td width="150" align="center" style="background-color:#F2F2F2; font-weight: 700;">작성자</td>
				<td width="450"><input type="text" name="writer" size="40" value="${loginAdmin.id}" style="border:none;" readonly required></td>
			</tr>			
			<tr height="40">
				<td width="150" align="center" style="background-color:#F2F2F2; font-weight: 700;">이메일</td>
				<td width="450"><input type="email" name="email"  size="40" value="admin@gmail.com" style="border:none;"readonly required></td>
			</tr>
			<tr height="40">
				<td width="150" align="center" style="background-color:#F2F2F2; font-weight: 700;">비밀번호</td>
				<td width="450"><input type="password" name="password"  size="40" style="border:none;" required></td>
			</tr>
			<tr height="40">
				<td width="150" align="center" style="background-color:#F2F2F2; font-weight: 700;">제목</td>
				 <td width="450"><input type="text" name="subject"  size="59" style="border:none;" required></td> 
			...
			<tr height="40">
				...
				<td width="450"><textarea rows="10" cols="60" name="content" style="border:none;" required></textarea></td>
			</tr>
