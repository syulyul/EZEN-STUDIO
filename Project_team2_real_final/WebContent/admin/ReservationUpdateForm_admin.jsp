...
<head>
<meta charset="UTF-8">
<title>ReservationUpdateForm_admin(예약 수정하기_관리자)</title>
<style type="text/css">
...
<!-- 만들어는 놨는데 사실상  ReservationUpdateForm.jsp 파일과 다른 점이 없음. 추후 사용할지 몰라 냅둠 -->
</head>
<body>
<%
...
<div align="center">
	<h2>예약 수정하기</h2><br>
<form action="ReservationUpdateProc_admin.jsp" method="post">
	<table width="500">
		<tr height="50">
